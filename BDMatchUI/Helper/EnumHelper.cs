...
{
    public enum SettingType : UInt32 { FFTNum, MinCnfrmNum, SearchRange, MinFinddB, MaxLength, SubOffset, OutputPCM, DrawSpec, MatchAss, ParallelDecode, FastMatch, VolMatch, WindowWidth, WindowHeight };
    ...
    public enum Scroll_Anchor_Type { End, Other };
}
